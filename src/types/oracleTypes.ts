import { Bitcoin, BTCUnit, Currency, ExchangeRate, Polkadot, DOTUnit, UnitList } from "@interlay/monetary-js";
...
export type DOTBTCOracleStatus = OracleStatus<Bitcoin, BTCUnit, Polkadot, DOTUnit>;
