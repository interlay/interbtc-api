...
import { BTC_IN_SAT, DOT_IN_PLANCK, decodeFixedPointType, TransactionUtils, encodeUnsignedFixedPoint } from "../utils";
...
export class DefaultOracleAPI implements OracleAPI {
    ...
    async setExchangeRate(dotPerBtc: string): Promise<void> {
        ...
        await this.transactionUtils.sendLoggedTx(tx, this.account);
    }
